...
import 'package:drunkendoor/models/entities/index.dart';
import 'package:drunkendoor/services/notification/notification_service.dart';
...
class FirebaseNotificationService extends NotificationService {
  ...
  Future<void> init({
    ...
    if (initMessage != null) {
      delegate.onMessageOpenedApp(drunkendoorNotificationItem(
    ...
    _notificationSubscription = FirebaseMessaging.onMessage.listen(
      (RemoteMessage message) {
        ...
        if (notification != null) {
          delegate.onMessage(drunkendoorNotificationItem(
