...
class S {
  ...
  /// `Opps, the recipes seems no longer exist`
  String get noBlog {
    return Intl.message(
      'Opps, the recipes seems no longer exist',
      name: 'noBlog',
  ...
  /// `There are no delivery options available. Please ensure that your address has been entered correctly, or contact us if you need any help.`
