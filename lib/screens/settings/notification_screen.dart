...
import '../../models/index.dart' show drunkendoorNotificationItem;
...
class _NotificationScreenState extends State<NotificationScreen>
  ...
  Widget build(BuildContext context) {
    return renderScaffold(
      ...
      child: Selector<NotificationModel,
          UnmodifiableListView<drunkendoorNotificationItem>>(
  ...
  void handleMessage(drunkendoorNotificationItem notificationItem) {
  ...
  void onTapMessage(drunkendoorNotificationItem data) async {
