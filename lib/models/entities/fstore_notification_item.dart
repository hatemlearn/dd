...
class drunkendoorNotificationItem {
  final String id;
  final String title;
  final String body;
  final bool seen;
  ...
  const drunkendoorNotificationItem({
    required this.id,
    required this.title,
    required this.body,
    this.additionalData,
  ...
  factory drunkendoorNotificationItem.fromJson(Map json) {
    return drunkendoorNotificationItem(
      id: json['id'],
      title: json['title'],
      body: json['body'],
      seen: json['seen'],
  ...
  drunkendoorNotificationItem copyWith({
    String? id,
    String? title,
    String? body,
    bool? seen,
